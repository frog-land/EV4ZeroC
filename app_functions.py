...
def show_page_header():
    ...
    st.markdown("<h2 style='text-align: center;padding-top: 0rem;'>Electric Vehicles Sales in New Zealand </h2>", unsafe_allow_html=True)
    #st.sidebar.markdown('<h1 style="font-size:small;padding-top: 0rem;">Under development by</h> <a style="text-align: center;font-size:small;padding-top: 0rem;" href="mailto: i.build.apps.4.u@gmail.com">Paula Maddigan</a>', unsafe_allow_html=True)
    st.sidebar.caption("Developed by Paula Maddigan",help="i.build.apps.4.u@gmail.com")
def get_data():
    # If data is already in the session state then return it, else load it from file
